...
class ElasticsearchOutputFactory:
    ...
    def create_from_configuration(configuration: dict) -> 'ElasticsearchOutput':
        ...
        try:
            es_output = ElasticsearchOutput(configuration['elasticsearch']['host'],
            ...
            raise InvalidConfigurationError(f'Elasticsearch: Missing configuration parameter '
...
class ElasticsearchOutput(Output):
    ...
    def __init__(self, host: str, port: int, default_index: str, error_index: str,
                 message_backlog_size: int, timeout: int):
        self._input = None
    ...
    def store_failed(self, error_message: str, document_received: dict, document_processed: dict):
        ...
        """
        error_document = {'error': error_message,
